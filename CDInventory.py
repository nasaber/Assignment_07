...
# NSaber, 2021-Nov-20, Added Functionality
# NSaber, 2021-Nov-27, Added Structured Error Handling
#------------------------------------------#
import pickle
# -- DATA -- #
...
class DataProcessor:
    ...
    @staticmethod
    def add_table(ID, title, artist):
        """Function to process and add the user input data to a 2D list table (list of dicts)
            
            Args:
                ID (string): CD ID input by the user
                title (string): Title of the CD input by the user
                artist (string): Artist name input by the user
    ...
    @staticmethod
    def row_delete(IDDel):
        """Function to search thru table and delete CD (row)
            
            Args:
                IDDel (string): CD ID to be deleted (input by the user)
...
class FileProcessor:
    ...
    def read_file(file_name):
        ...
        Reads the data from binary file identified by file_name 
        ...
        Returns:
            table(object): the data read from the file
        """
    ...
    def write_file(file_name, table):
        ...
        Args:
            ...
            table (Object): the data to be saved to the file
...
while True:
    ...
    # 3.3 process add a CD
        ...
        try:        
            DataProcessor.add_table(strID, strTitle, stArtist)
            IO.show_inventory(lstTbl)
    ...
    # 3.5 process delete a CD
        ...
        DataProcessor.row_delete(intIDDel)
        IO.show_inventory(lstTbl)
        continue  # start loop back at top.
